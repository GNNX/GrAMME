...
def main(args):
    ...
    if multiplex_features is None:
        multiplex_features = np.random.randn(N, inp_dim)  # Randomly generated features
    ...
    # feed dictionaries
    feed_dict_train = construct_Supra_feed_dict(all_edgelist, multiplex_features, y_train, train_mask, place_holders,
                                                attention_dropout=att_dropout_keeprate, input_dropout=inp_dropout_keeprate)
    feed_dict_val = construct_Supra_feed_dict(all_edgelist, multiplex_features, y_val, val_mask, place_holders)
    feed_dict_test = construct_Supra_feed_dict(all_edgelist, multiplex_features, y_test, test_mask, place_holders)
